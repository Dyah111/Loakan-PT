...
@section('content')
    <div class="max-w-2xl mx-auto py-8">
        ...
        <div class="bg-white p-4 rounded shadow mb-6">
            <form>
                <textarea rows="3" class="w-full border border-gray-300 rounded p-2 mb-2"
                ...
                <div class="absolute top-4 right-4">
                    ...
                    <div x-show="open" @click.away="open = false"
                        ...
                        <ul class="text-sm text-gray-700">
                            ...
                            <li @click="alert('Forum diblokir')" class="px-4 py-2 hover:bg-gray-100 cursor-pointer">Blokir Forum
                            </li>
                            <li @click="alert('Forum dibagikan')" class="px-4 py-2 hover:bg-gray-100 cursor-pointer">Share</li>
                        </ul>
                    </div>
                </div>
